...
strains are related, i.e. constrained by each other. Four strains are considered, wild-type (wt), MMR-deactivated (MMR-), proofreading-deficient (proof-) and MMR-deactivated and proofreading-deficient (MMR-_proof-).
...
error rate is observed directly for the mutant MMR-_proof- for which both MMR and Proofreading are inactivated.
